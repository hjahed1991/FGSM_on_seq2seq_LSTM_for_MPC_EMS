...
ARTIFACTS_PATH = CLEAN_ARTIFACTS_SAVE_PATH / 'artifacts' # Load artifacts from here, save predictions here
JSON_PATH = CLEAN_ARTIFACTS_SAVE_PATH / 'json_files' # save predictions here
